...
The analysis was carried out in statistical software R, using a two-sided 2 proportion z-test (R version 4.3.0). The proportions of success for each method were calculated from the *success* variable. I created a *trials* variable in the analysis data as an identifier for each trial, which gave each observation the corresponding trial number based on occurrence during the experiment. The *which_cup* and *method* variables were converted from numeric to factor variables. I did this in order to relabel the "0" cup level in *which_cup* into a level named "None".

#### Diagram 1 --- Cup Formation
